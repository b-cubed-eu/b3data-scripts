...
The b3data data package is itself is available here (URL provided when published).
This data package contains the data resources for the [b3verse](https://docs.b-cubed.eu/guides/b3verse/).
It is created using the [frictionless](https://docs.ropensci.org/frictionless/) R package and can be imported using functions provided by that package.
